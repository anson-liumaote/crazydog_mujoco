...
if __name__ == "__main__":
    ...
    with open(f"/home/csl/robot_model/bi_urdf/{config_file}", "r") as f:
    ...
    with mujoco.viewer.launch_passive(m, d) as viewer:
        ...
        while viewer.is_running() and time.time() - start < simulation_duration:
            ...
            tau = pd_control(target_dof_pos, d.sensordata[:NUM_MOTOR], kps, np.array([action[0], action[1]]), d.sensordata[NUM_MOTOR:NUM_MOTOR + NUM_MOTOR], kds)
            ...
            if counter % control_decimation == 0 and counter > 0:
                ...
                # create observation
                qvel = d.sensordata[2:4]
                lin_vel_I = d.sensordata[19:22]
                ang_vel_I = d.sensordata[22:25]
                gravity_b = get_gravity_orientation(d.sensordata[6:10])
